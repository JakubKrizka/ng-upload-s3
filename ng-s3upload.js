...
angular.module('ngS3upload').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('theme/bootstrap3.html',
    ...
    "  <button class=\"btn btn-primary\" type=\"button\"><span ng-if=\"!filename\">Choose file</span><span ng-if=\"filename\">Upload another</span></button>\n" +
    "  <a ng-href=\"{{ filename }}\" target=\"_blank\" class=\"\" ng-if=\"filename\" ><button type=\"button\" class=\"btn btn-success\" style=\"float:right\"> link to => stored file </button></a>\n" +
    "  <div class=\"progress\">\n" +
    "    <div class=\"progress-bar progress-bar-striped progress-bar-success\" ng-class=\"{active: uploading}\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: {{ progress }}%\" ng-class=\"barClass()\">\n" +
    "      <span class=\"sr-only\" style=\"position: relative\">{{progress}}% Complete</span>\n" +
    "    </div>\n" +
    "  </div>\n" +
